export const restaurantsCleaner = 
jest.fn().mockImplementation(restaurantsArray => {
  return restaurantsArray.map(restaurant => {
    const { apiKey, logoUrl, name, streetAddress, city, 
      state, zip, foodTypes, phone, url } = restaurant;
